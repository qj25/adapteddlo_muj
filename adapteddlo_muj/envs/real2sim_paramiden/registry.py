...
from adapteddlo_muj.envs.real2sim_paramiden import (
    adapt,
    cosserat,
    cosserat3,
    cosserat5,
...
DEFAULT_MODELS = ["adapt", "native", "massspring", "cosserat"]
...
MODEL_REGISTRY = {
    ...
    "cosserat5": cosserat5.get_model_spec(),
...
def get_model_specs(model_names: List[str]) -> Dict:
    ...
    if unknown:
        raise ValueError(
            f"Unknown real2sim_paramiden model(s): {unknown}. "
