...
const Eigen::Vector3d Cosserat4Utils::rotateVector3(const Eigen::Vector3d &v, const Eigen::Vector3d &u, const double a)
{
    Eigen::Matrix3d R;
...
const double Cosserat4Utils::calculateAngleBetween(const Eigen::Vector3d &v1, const Eigen::Vector3d &v2)
{
    double cos_ab, ab;
    ...
    ab = acos(cos_ab);
    if (std::isnan(ab)) {
        std::string str_error = "Error in Cosserat4Utils::calculateAngleBetween";
...
const double Cosserat4Utils::calculateAngleBetween2(const Eigen::Vector3d &v1, const Eigen::Vector3d &v2, const Eigen::Vector3d &v_anchor)
{
...
const Eigen::Matrix3d Cosserat4Utils::createSkewSym(const Eigen::Vector3d &v)
{
...
const Eigen::Vector4d Cosserat4Utils::inverseQuat(const Eigen::Vector4d &quat)
{
...
const Eigen::Vector3d Cosserat4Utils::rotVecQuat(const Eigen::Vector3d &vec, const Eigen::Vector4d &quat)
{
    Eigen::Vector3d res;
    Eigen::Vector3d tmp;
    // zero vec: zero res
...
//     a2 = Cosserat4Utils::calculateAngleBetween2(bf1.row(0), bf1.row(1), -bf1.row(2));
//     std::cout << a2 << std::endl;
//     // a1 = bf2.x.dot(bf1.x);
//     // std::cout << a1 << std::endl;

//     // ss1 = Cosserat4Utils::createSkewSym(bf2.x);
