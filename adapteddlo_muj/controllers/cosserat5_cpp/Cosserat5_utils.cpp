...
const Eigen::Vector3d Cosserat5Utils::rotateVector3(
...
const double Cosserat5Utils::calculateAngleBetween(
...
const Eigen::Matrix3d Cosserat5Utils::createSkewSym(const Eigen::Vector3d& v)
{
...
const Eigen::Vector4d Cosserat5Utils::inverseQuat(const Eigen::Vector4d& quat)
{
...
const Eigen::Vector3d Cosserat5Utils::rotVecQuat(
...
Eigen::Vector3d Cosserat5Utils::rotvecFromRotationMatrix(const Eigen::Matrix3d& R)
{
