...
SWIGINTERN PyObject *_wrap_new_MassSpring(PyObject *self, PyObject *args) {
  ...
  (void)self;
  if (!SWIG_Python_UnpackTuple(args, "new_MassSpring", 3, 3, swig_obj)) SWIG_fail;
  {
    npy_intp size[1] = {
      -1
    };
  ...
  result = (MassSpring *)new MassSpring(arg1,arg2,arg3,arg4);
...
SWIGINTERN PyObject *_wrap_MassSpring_setStiffness(PyObject *self, PyObject *args) {
  ...
  (void)self;
  if (!SWIG_Python_UnpackTuple(args, "MassSpring_setStiffness", 3, 3, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_MassSpring, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
