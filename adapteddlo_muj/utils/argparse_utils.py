...
def tswa_parse():
    ...
    # Add arguments with default values
    parser.add_argument('--stiff', type=str, default=['adapt','native'], help='specify stiffness type: native or adapt [default: all]')
    parser.add_argument('--wirecolor', type=str, default=['black','red','white'], help='specify wire color: black, red, or white [default: all]')
